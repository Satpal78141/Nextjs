    ...
    return (
        <div className={`m-auto ${HomeStyle.container} bg-white`} >
            ...
            <div className={`flex ${HomeStyle.transparent} `}>
                ...
                <img src='https://www.subly.app/spotify.png' className={`w-10 h-10 rounded-full float-left ${HomeStyle.dis}`} data-aos="fade-up"
            ...
            <div className={`flex p-12 ${HomeStyle.headingSection}`}>
                ...
                <div className={`${HomeStyle.wrapper} ${HomeStyle.dis}`}>
