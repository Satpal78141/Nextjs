...
const Feature = () => {
    ...
    return (
        <div id="feature" className={`${featureStyle.feature}`}>
            <div className={`${featureStyle.flex_cards} ${featureStyle.underDiv}`}>
                <div className={`${featureStyle.text}`} data-aos="fade-left">
                    <p className={`${featureStyle.fullwidth} ${featureStyle.heading}`}>Keep track of all your subscriptions</p>
                    ...
                    <a href='https://web.subly.app/signup'>Get started for free  </a>
            ...
            <div className={`${featureStyle.flex_cards} ${featureStyle.underDiv} ${featureStyle.background_white}`}>
                <div className={featureStyle.imgDiv} data-aos="fade-right" data-aos-duration="1000">
                    <img className={featureStyle.img} src='https://www.subly.app/insights.png' />
                </div>
                <div className={`${featureStyle.text}`} data-aos="fade-left" data-aos-duration="1000">
